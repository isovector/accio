...
create table "Event" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"eventType" VARCHAR(254) NOT NULL,"task" INTEGER,"start" VARCHAR(254) NOT NULL,"duration" BIGINT NOT NULL,"where" VARCHAR(254) NOT NULL,"description" VARCHAR(254) NOT NULL);
